"""
Servicios del módulo chatbot.
"""

from .services.service_statistics import obtener_estadisticas_chatbot
from .services.service_ai import procesar_consulta_con_ia
